  ...
  return (
    <form action={formAction} className="editor-form">
      ...
      <aside className="editor-sidebar">
        ...
        <div className="sidebar-status"><span>Status</span><strong><span className={`dot-status ${article.status === "Publiceret" || article.status === "Distribueret" ? "dot-published" : article.status === "Planlagt" ? "dot-scheduled" : article.status === "Arkiveret" || article.status === "Afvist" ? "dot-archived" : "dot-draft"}`} /> {article.status}</strong></div>
