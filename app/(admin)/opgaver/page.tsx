...
export default async function AssignmentsPage({ searchParams }: PageProps<"/opgaver">) {
  ...
  return <main className="admin-main">
    <div className="page-heading"><div><h1>Opgaver</h1><p className="text-muted">{assignments.length} aktive og historiske opgaver</p></div>{canManage && <Link className="btn btn-primary" href="/opgaver/ny"><Plus size={17} /> Ny opgave</Link>}</div>
