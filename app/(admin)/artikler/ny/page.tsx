...
export default async function NewArticlePage() {
  ...
  return <main className="editor-page"><div className="editor-topbar"><Link href="/artikler" className="btn btn-ghost"><ChevronLeft size={16} /> Tilbage</Link><div><span className="eyebrow">Ny artikel</span><h1>Uden titel</h1></div></div><ArticleForm article={{ id: null, titel: "", manchet: "", slug: "", blocks: [{ id: "initial-paragraph", type: "paragraph", data: { content: "" } }], status: "Idé", indholdstype: "Uafhængig", aiBrug: ["Ingen"], marking: null, pinned: false, breaking: false, seoTitel: "", seoBeskrivelse: "", sprog: "da", kategoriId: "", forfatterId: session.user.authorId ?? "", coverMediaId: "", tagIds: [], geoTagIds: [] }} categories={categories} authors={authors} tags={tags} geoTags={geoTags} media={media} transitions={[]} canPublish={can(session.user, PERMISSIONS.ARTICLE_PUBLISH)} /></main>;
}
